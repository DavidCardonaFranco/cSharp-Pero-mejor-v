...
public class MyNewGrammar implements MyNewGrammarConstants {
  ...
  public static void main(String args []) throws ParseException
  {
   MyNewGrammar parser = new MyNewGrammar(System.in);
    while (true){
      System.out.print("Ingrese una ecuaci\u00c3\u00b3n del tipo:  \u005c"int a = 1+(2+3)*4;\u005c" :");
      try
      {
        switch (MyNewGrammar.one_line())
        {
          case 0 :
          System.out.println("ERES LA BLOWJOB MIJO");
          break;
          case 1 :
      ...
      {
        System.out.println("NO DIO PERO DE OTRA FORMA :V");
        System.out.println(e.getMessage());
        break;
      }
    }
...
*/
 ...
 System.out.println(espaciado+" | expression_statement");
